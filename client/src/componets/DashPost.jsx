              ...
              userPosts.map((post)=>(
                <Table.Body className='divide-y'>
                  <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                    ...
                    <Table.Cell>
                      <Link className='text-teal-400 hover:underline' to={`/update-post/${post._id}`}>
                      <span>Edit</span>
                      </Link>
                    </Table.Cell>
                  </Table.Row>
      ...
      <Modal show={showModal} onClose={()=>setShowModal(false)} popup size="md">
        ...
        <Modal.Body>
            <div className="text-center">
                ...
                <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure you to  delete this post?
                </h3>
                <div className="flex justify-center gap-4">
                    <Button color="failure" onClick={handleDeletePost}>
                        Yes I'm Sure
                        </Button> 
                    <Button className='gray' onClick={()=>setShowModal
                    (false)}>
                        No, Cancle
